<?php
// Menambahkan 7 jam ke $last_login
$last_login = date('Y-m-d H:i:s', strtotime($last_login . '+7 hours'));
?>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url(); ?>" class="logo">
        ...
        <span class="logo-lg"><b>Mamah Tias</b></span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          if (
            $is_admin == 1 ||
            (array_key_exists('Dashboard', $access_info)
              && ($access_info['Dashboard']['list'] == 1 || $access_info['Dashboard']['total_access'] == 1))
          ) {
            ?>
            <li>
          ...
          if (
            $is_admin == 1 ||
            (array_key_exists('Customers', $access_info)
              && ($access_info['Customers']['list'] == 1 || $access_info['Customers']['total_access'] == 1)) ||
            (array_key_exists('Properties', $access_info)
              && ($access_info['Properties']['list'] == 1 || $access_info['Properties']['total_access'] == 1))
          ) {
            ?>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  <a href="<?php echo base_url(); ?>properties/propertyListing">
                    <i class="fa fa-home"></i>
                    <span>Daftar Property</span>
                  </a>
                </li>
              </ul>
            </li>
          ...
          if (
            $is_admin == 1 ||
            (array_key_exists('Rentals', $access_info)
              && ($access_info['Rentals']['list'] == 1 || $access_info['Rentals']['total_access'] == 1))
          ) {
            ?>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="<?php echo base_url(); ?>rentals/rentalListing">
          ...
          if (
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-rocket"></i> <span>Automation</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
