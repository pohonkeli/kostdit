...
class User extends BaseController
{
    ...
    function addNew()
    {
        if (!$this->isAdmin()) {
            ...
            $this->global['pageTitle'] = 'MamahTias : Add New User';
    ...
    function editOld($userId = NULL)
    {
        if (!$this->isAdmin()) {
            ...
            $this->global['pageTitle'] = 'MamahTias : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'MamahTias : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        if (!$this->isAdmin()) {
            ...
            $this->global['pageTitle'] = 'MamahTias : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'MamahTias : My Profile' : 'MamahTias : Change Password';
